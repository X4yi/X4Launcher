...
namespace x4::auth {
    ...
    QUrl MicrosoftOAuthClient::buildAuthorizeUrl(const QString &clientId, const QString &redirectUri,
                                                 const QString &state, const QString &pkceChallenge,
                                                 const QString &pkceMethod) const {
    ...
    void MicrosoftOAuthClient::exchangeCodeForToken(const QString &clientId, const QString &redirectUri,
                                                    const QString &code, const QString &pkceVerifier) {
        QUrlQuery body;
    ...
    void MicrosoftOAuthClient::refreshToken(const QString &clientId, const QString &redirectUri,
    ...
    void MicrosoftOAuthClient::onTokenReply() {
        ...
        qDebug() << "[Auth] Token endpoint HTTP status:" << reply->attribute(QNetworkRequest::HttpStatusCodeAttribute).
                toInt();

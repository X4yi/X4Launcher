...
public:
    ...
    QUrl buildAuthorizeUrl(const QString& clientId, const QString& redirectUri, const QString& state, const QString& pkceChallenge, const QString& pkceMethod) const;

    // Exchanges the code for tokens
    void exchangeCodeForToken(const QString& clientId, const QString& redirectUri, const QString& code, const QString& pkceVerifier);
...
private:
    ...
    static constexpr const char* AuthorizeEndpoint = "https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize";

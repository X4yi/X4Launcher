...
namespace x4 {
    ...
    void Translator::loadEnglish() {
        ...
        // New keys
        dict["settings.java.managed"] = "managed";
        dict["settings.zen.restart.title"] = "Restart Required";
        dict["settings.zen.restart.msg"] = "The application will now restart to apply the mode change.";
        dict["editor.msg.del.title"] = "Confirm Deletion";
        dict["editor.msg.del.desc"] = "Are you sure you want to delete the selected items?";
        dict["editor.msg.update.title"] = "Update";
        dict["editor.msg.update.desc"] = "Update logic goes here.";
    ...
    void Translator::loadSpanish() {
        ...
        // New keys
        dict["settings.java.managed"] = "gestionado";
        dict["settings.zen.restart.title"] = "Reinicio Requerido";
        dict["settings.zen.restart.msg"] = "La aplicación se reiniciará para aplicar el cambio de modo.";
        dict["editor.msg.del.title"] = "Confirmar Eliminación";
        dict["editor.msg.del.desc"] = "¿Estás seguro de que deseas eliminar los elementos seleccionados?";
        dict["editor.msg.update.title"] = "Actualizar";
        dict["editor.msg.update.desc"] = "Lógica de actualización aquí.";

...
connect(meta, &MetaAPI::indexFinished, this, [this, meta, instanceId, inst, uid, handlePatchJson](const QString&, const QByteArray& idxData) {
            ...
            connect(meta, &MetaAPI::versionFinished, this, [this, handlePatchJson](const QString&, const QString&, const QByteArray& pdata) { handlePatchJson(pdata); });
            connect(meta, &MetaAPI::versionFailed, this, [this, meta, instanceId](const QString&, const QString&, const QString& err) { emit launchFailed(instanceId, "Mod Loader DL Error: " + err); meta->deleteLater(); });
            ...
            if (f.open(QIODevice::ReadOnly)) {
                ...
                if (dm2->totalCount() > 0) {
                    ...
                    connect(dm2, &DownloadManager::overallProgress, this, [instanceId](int completed, int total) {
                        ...
                        GlobalEvents::instance().downloadProgress(pct, QStringLiteral("Assets: %1/%2").arg(completed).arg(total));
                    });

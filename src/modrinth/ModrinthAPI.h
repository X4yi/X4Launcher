...
public:
    ...
    void searchProjects(const QString& query, const QString& facets, int limit = 20, int offset = 0, const QString& index = "relevance");
    void getProjectVersions(const QString& projectId, const QString& mcVersion = QString(), const QString& loader = QString());

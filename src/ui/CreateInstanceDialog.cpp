...
void CreateInstanceDialog::setupUI() {
    ...
    basicGroup->setStyleSheet(QStringLiteral("QGroupBox { font-weight: bold; border: 1px solid #292e42; border-radius: 6px; margin-top: 10px; } QGroupBox::title { subcontrol-origin: margin; left: 10px; color: #7aa2f7; }"));
    ...
    struct IconDef { QString key; QString label; };
    ...
    for (int i = 0; i < icons.size(); ++i) {
        ...
        btn->setStyleSheet(QStringLiteral("QToolButton { border: 2px solid transparent; border-radius: 8px; background: transparent; padding: 4px; }"
    ...
    verGroup->setStyleSheet(QStringLiteral("QGroupBox { font-weight: bold; border: 1px solid #292e42; border-radius: 6px; margin-top: 10px; } QGroupBox::title { subcontrol-origin: margin; left: 10px; color: #7aa2f7; }"));
    ...
    summaryLabel_->setStyleSheet(QStringLiteral("color: #bb9af7; font-weight: bold; font-size: 12px; margin-bottom: 8px;"));

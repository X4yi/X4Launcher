...
private:
    ...
    QMap<QString, CachedMetadata> metadataCache_;
    void loadMetadataCache();
    void saveMetadataCache();
    void downloadIconForCache(const QString& sha1, const QString& url, QListWidgetItem* item);
};

...
namespace x4 {
    ...
    void KeyBindManager::registerBind(KeyBind bind, const QKeySequence &seq, const QString &name) {
        ...
        switch (bind) {
            case KeyBind::LaunchInstance: connect(action, &QAction::triggered, this,
                                                  &KeyBindManager::launchInstanceTriggered);
                break;
            case KeyBind::EditInstance: connect(action, &QAction::triggered, this,
                                                &KeyBindManager::editInstanceTriggered);
                break;
            case KeyBind::AddInstance: connect(action, &QAction::triggered, this,
                                               &KeyBindManager::addInstanceTriggered);
                break;
            case KeyBind::DeleteInstance: connect(action, &QAction::triggered, this,
                                                  &KeyBindManager::deleteInstanceTriggered);
                break;
            case KeyBind::CloneInstance: connect(action, &QAction::triggered, this,
                                                 &KeyBindManager::cloneInstanceTriggered);
                break;
            case KeyBind::OpenInstanceFolder: connect(action, &QAction::triggered, this,
                                                      &KeyBindManager::openInstanceFolderTriggered);
                break;
            case KeyBind::GlobalSettings: connect(action, &QAction::triggered, this,
                                                  &KeyBindManager::globalSettingsTriggered);
                break;
            case KeyBind::FocusSearch: connect(action, &QAction::triggered, this,
                                               &KeyBindManager::focusSearchTriggered);
                break;
            case KeyBind::Quit: connect(action, &QAction::triggered, this, &KeyBindManager::quitTriggered);
                break;
        }

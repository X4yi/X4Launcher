...
void MainWindow::setupZenUI() {
    ...
    connect(importBtn, &QPushButton::clicked, this, [this]() {
        ...
        if (result.isErr()) {
            ...
            instanceList_->refresh();
            updateStatusBar();
            if (!zenMode_) statusBar()->showMessage(
...
void MainWindow::setupSidebar() {
    ...
    sidebarLayout->addWidget(createBtn(zen ? QStringLiteral("[+] Add Instance") : X4TR("main.sidebar.add"), &MainWindow::addInstance));
    ...
    sidebarLayout->addWidget(createBtn(zen ? QStringLiteral("[o] Folder") : X4TR("main.sidebar.folder"), &MainWindow::openInstanceFolder));
    ...
    sidebarLayout->addWidget(createBtn(zen ? QStringLiteral("[@] Accounts") : X4TR("main.sidebar.accounts"), &MainWindow::openAccounts));
    sidebarLayout->addWidget(createBtn(zen ? QStringLiteral("[*] Settings") : X4TR("main.sidebar.settings"), &MainWindow::openSettings));
